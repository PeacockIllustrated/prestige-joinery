...
const TaskCard: React.FC<TaskCardProps> = ({ task, onClick }) => {
  ...
  return (
    <div 
        onClick={onClick}
        className="bg-white p-4 rounded-lg shadow-sm border border-prestige-gray/60 hover:shadow-md hover:border-prestige-teal/50 cursor-pointer transition-all duration-200"
    >
      <h4 className="font-bold text-prestige-charcoal truncate mb-3">{task.title}</h4>
      
      <div className="flex justify-between items-center pt-3 border-t border-prestige-gray">
        ...
        <span className="text-xs font-medium text-prestige-text">
