...
const CompletedProjectsAccordion: React.FC<CompletedProjectsAccordionProps> = ({ projects, onSelectTask }) => {
    ...
    return (
        <div className="border border-prestige-gray rounded-xl bg-white/50">
            <button
                onClick={() => setIsOpen(!isOpen)}
                className="flex items-center justify-between w-full p-4 font-bold text-prestige-charcoal"
            >
