...
// FIX: Renamed the `document` prop to `documentProp` during destructuring to avoid shadowing the global `document` object.
const DocumentRow: React.FC<DocumentRowProps> = ({ document: documentProp, onDelete }) => {
