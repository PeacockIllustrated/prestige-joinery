      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="p-6 border-b border-prestige-gray">
            <h2 className="text-2xl font-bold text-prestige-charcoal">Confirm Invoice Details</h2>
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[70vh] overflow-y-auto">
            ...
            <div className="bg-prestige-light-gray rounded-lg p-2 border border-prestige-gray">
          ...
          <div className="p-6 bg-prestige-light-gray flex justify-end items-center rounded-b-xl space-x-3">
             ...
             <button type="submit" className="px-5 py-2.5 bg-prestige-teal text-prestige-charcoal font-bold rounded-lg shadow-sm hover:bg-opacity-90 transition">Confirm and Log Cost</button>
          </div>
        </form>
      </div>
      <style>{`
