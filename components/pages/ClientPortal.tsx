        ...
        return (
            <div className="space-y-6">
                <div className="flex items-center space-x-3">
                    <div className="bg-prestige-teal/20 p-2 rounded-lg">
                        <UsersIcon className="w-6 h-6 text-prestige-teal" />
                    </div>
                    <div>
                        <h1 className="text-3xl font-bold text-prestige-charcoal">Client Portal</h1>
                        <p className="mt-1 text-prestige-text">Select a project to view its details.</p>
                    </div>
                </div>
