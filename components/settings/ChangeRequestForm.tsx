  ...
  return (
    <div className="bg-white rounded-xl shadow-md border border-prestige-gray/50">
      <div className="p-6 border-b border-prestige-gray flex items-center space-x-3">
        <LightbulbIcon className="w-6 h-6 text-prestige-teal"/>
        <div>
            <h2 className="text-xl font-bold text-prestige-charcoal">Log a Change Request</h2>
            <p className="text-sm text-prestige-text">Have an idea for an improvement? Log it here for the development team.</p>
        </div>
      </div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="p-6 bg-prestige-light-gray flex justify-end rounded-b-xl">
          <button
            type="submit"
            disabled={isSubmitting}
            className="px-6 py-2.5 bg-prestige-teal text-prestige-charcoal font-bold rounded-lg shadow-sm hover:bg-opacity-90 transition disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
