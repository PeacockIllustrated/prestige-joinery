    ...
    >
      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6 bg-prestige-light-gray flex justify-between items-center rounded-b-xl">
             {staffMember && (
             ...
             <div className="flex-grow flex justify-end space-x-3">
                ...
                <button type="submit" className="px-5 py-2.5 bg-prestige-teal text-prestige-charcoal font-bold rounded-lg shadow-sm hover:bg-opacity-90 transition">{staffMember ? 'Save Changes' : 'Create Member'}</button>
             </div>
          </div>
        </form>
      </div>
